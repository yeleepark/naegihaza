...
export function getMetadata(locale: Locale) {
  return {
    home: {
      title: locale === 'ko' ? '랜덤 선택기 · 룰렛 · 사다리타기 · 팀 나누기 무료 온라인 도구' :
      ...
      description: locale === 'ko' ? '친구들과 빠르게 결정하세요. 룰렛, 사다리타기, 주사위, 벌칙 정하기, 팀 나누기를 한 번에 사용할 수 있는 무료 랜덤 선택 도구입니다.' :
      ...
      keywords: locale === 'ko' ? ['랜덤 게임', '랜덤 선택기', '랜덤 추첨기', '룰렛 돌리기', '사다리타기', '주사위 굴리기', '벌칙 정하기', '제비뽑기', '당번 뽑기', '이름 추첨기', '팀 나누기', '메뉴 정하기', '누가 계산', '술게임 정하기', '파티 게임', '친구 게임', '선택 장애 해결', '온라인 랜덤 도구', '무료 랜덤 선택 사이트', '랜덤 결정 도구'] :
    ...
    dice: {
      title: locale === 'ko' ? '온라인 주사위 굴리기 – 랜덤 숫자 생성기' :
        locale === 'en' ? 'Dice Roll | Naegihaza' :
          locale === 'zh' ? '掷骰子 | Naegihaza' :
            'Lanzar Dados | Naegihaza',
      description: locale === 'ko' ? '주사위를 빠르게 굴려 결과를 확인하세요. 게임, 내기, 순서 정하기 등 다양한 상황에서 사용할 수 있는 무료 주사위 도구입니다.' :
      ...
      keywords: locale === 'ko' ? ['주사위 굴리기 사이트', '랜덤 숫자 생성기', '순서 정하기', '온라인 주사위'] :
    ...
    roulette: {
      title: locale === 'ko' ? '랜덤 룰렛 돌리기 – 이름 추첨 · 당번 · 내기 정하기 온라인' :
        locale === 'en' ? 'Random Roulette | Naegihaza' :
          locale === 'zh' ? '随机轮盘 | Naegihaza' :
            'Ruleta Aleatoria | Naegihaza',
      description: locale === 'ko' ? '이름을 입력하고 룰렛을 돌려 한 명을 선택하세요. 누가 계산할지, 당번 정하기, 벌칙 정하기에 사용할 수 있는 무료 랜덤 선택 도구입니다.' :
      ...
      keywords: locale === 'ko' ? ['룰렛 돌리기 사이트', '이름 추첨기', '당번 뽑기', '누가 계산', '랜덤 선택기'] :
    ...
    ladder: {
      title: locale === 'ko' ? '사다리타기 온라인 – 랜덤 추첨 · 제비뽑기 도구' :
        locale === 'en' ? 'Ladder Game | Naegihaza' :
          locale === 'zh' ? '爬梯游戏 | Naegihaza' :
            'Juego de Escalera | Naegihaza',
      description: locale === 'ko' ? '참가자와 결과를 입력하면 즉시 결과를 확인할 수 있습니다. 당첨, 벌칙, 점심 메뉴 정하기 등에 사용하는 무료 사다리타기 도구입니다.' :
      ...
      keywords: locale === 'ko' ? ['사다리타기 사이트', '제비뽑기', '랜덤 추첨', '벌칙 정하기', '점심 메뉴 정하기'] :
    ...
    bomb: {
      title: locale === 'ko' ? '폭탄 뽑기 게임 – 벌칙 정하기 랜덤 선택' :
        locale === 'en' ? 'Bomb Draw | Naegihaza' :
          locale === 'zh' ? '炸弹抽取 | Naegihaza' :
            'Bomba | Naegihaza',
      description: locale === 'ko' ? '카드를 선택해 벌칙 당첨자를 정하세요. 친구, 파티, 술자리에서 사용하는 간단한 벌칙 선택 게임입니다.' :
      ...
      keywords: locale === 'ko' ? ['벌칙 정하기', '술게임 벌칙', '벌칙 뽑기', '랜덤 벌칙 선택'] :
